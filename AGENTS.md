...
- `typst c main.typ resume.pdf` — one-off compile to `resume.pdf`; run before committing to ensure deterministic output.
- `typst watch main.typ resume.pdf` — live preview during edits.
